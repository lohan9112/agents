...
def send_test_email():
    ...
    from_email = Email("ed@edwarddonner.com")   # đổi thành sender đã verify
    to_email = To("ed.donner@gmail.com")        # đổi thành email nhận
...
# =======================
# PARALLEL DEMO + PICKER
# =======================

sales_picker = Agent[Any](
    name="sales_picker",
...
async def demo_parallel_and_picker():
...
subject_writer = Agent(
    ...
    instructions="Write a subject for a cold sales email that is likely to get a response.",
    model="gpt-4o-mini"
)

html_converter = Agent(
    name="HTML email body converter",
    instructions="Convert a text email body to an HTML email body with clean layout.",
    model="gpt-4o-mini"
)
...
async def main():
    ...
    print("\n=== Parallel + picker demo ===")
    await demo_parallel_and_picker()
